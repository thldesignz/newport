...
const Projects = [
    {
       ...
       desc: 'This is a full stack application built using Laravel and react. It’s for a restaurant that i made up. on the back end you can add employees in the system as well as add more food categories and items to the restaurant. Admin you can sales as well as other features that regular employees can’t see.' ,
   ...
   },
   {
      ...
      desc: 'Before the email was just plain text, no images just text and links. So I offered to redo the email so that when customers open it its more appealing and you may get more clicks. The color scheme is the same color scheme from his website so the brand and color schemes flow together. I added his logo and as well as an image. I coded everything in HTML and CSS and it is fully responsive.' ,
   ...
   },
   {
      ...
      title:'Promotional Email',  
      subTitle:'Email Development',  
      desc: 'This is an example of a promotional email that I created. This email is created with HTML and CSS. This email is fully responsive and was tested using litmus. It displays correctly across all major email clients. This email consists mainly of optimized images then at the bottom we have text.' ,
      tools: 'Litmus, Netlify, Photoshop',
      languages: 'css, html',
      datec: '25 Jan 2022',
      category: 'Web',
   ...
   },
   {
      ...
      subTitle:'Email Development',  
      desc: 'This is an example of a Transactional email that I created. This email is created with HTML and CSS. This email is fully responsive and was tested using litmus. It displays correctly across all major email clients. This email consists optimized images then at the bottom we have text.' ,
      tools: 'Litmus, Netlify, Photoshop',
      languages: 'css, html',
      datec: '25 Jan 2022',
      category: 'Web',
